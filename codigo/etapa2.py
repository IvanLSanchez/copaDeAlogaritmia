...
def validarExistenciaClave(dDiccionario, iDato):
  ...
  print(dDiccionario) # line35: validarExistenciaClave(dVotosRegion, iVotoRegion) -> {}
  print(lClaves) # ine 35: validarExistenciaClave(dVotosRegion, iVotoRegion) -> dict_keys([])
  if iDato in lClaves:
    bExiste = True
  return bExiste
